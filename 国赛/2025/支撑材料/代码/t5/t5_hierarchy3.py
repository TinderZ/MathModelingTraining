...
if __name__ == "__main__":
    ...
    PRIMARY_DRONES = [2]  # 第3层: 优化 FY3
    SECONDARY_DRONES = [0, 1, 3, 4]
    ...
    init_pos_list = []
    primary_solutions_fy3 = drone_solutions[2]

    for prim_sol in primary_solutions_fy3:
        for _ in range(N_COMBINATIONS_PER_PRIMARY):
            ...
            particle = np.concatenate([sec_sol_fy1, sec_sol_fy2, prim_sol, sec_sol_fy4, sec_sol_fy5])
