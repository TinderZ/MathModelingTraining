...
if __name__ == "__main__":
    ...
    PRIMARY_DRONES = [1]  # 第2层: 优化 FY2
    SECONDARY_DRONES = [0, 2, 3, 4]
    ...
    init_pos_list = []
    primary_solutions_fy2 = drone_solutions[1]

    for prim_sol in primary_solutions_fy2:
        for _ in range(N_COMBINATIONS_PER_PRIMARY):
            ...
            particle = np.concatenate([sec_sol_fy1, prim_sol, sec_sol_fy3, sec_sol_fy4, sec_sol_fy5])
