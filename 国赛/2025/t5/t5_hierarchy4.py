...
if __name__ == "__main__":
    ...
    # 定义分层
    PRIMARY_DRONES = [4]  # 第4层: 优化 FY5
    SECONDARY_DRONES = [0, 1, 2, 3]
    ...
    init_pos_list = []
    primary_solutions_fy5 = drone_solutions[4]

    for prim_sol in primary_solutions_fy5:
        for _ in range(N_COMBINATIONS_PER_PRIMARY):
            ...
            particle = np.concatenate([sec_sol_fy1, sec_sol_fy2, sec_sol_fy3, sec_sol_fy4, prim_sol])
