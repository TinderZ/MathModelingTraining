...
# 无人机FY2参数
FY2_INITIAL_POS = np.array([12000.0, 1400.0, 1400.0])
...
def calculate_occlusion_time_single(params):
    ...
    drone_pos_at_drop = FY2_INITIAL_POS + drone_velocity * T_DROP
...
def check_params_validity(params):
    ...
    drone_pos_at_drop = FY2_INITIAL_POS + drone_velocity * t_take
    detonation_point = drone_pos_at_drop + drone_velocity * t_fall
    detonation_point[2] -= 0.5 * G * t_fall**2
...
if __name__ == "__main__":
    ...
    bounds_low = [np.pi+0.09, 70, 5, 6]
    bounds_high = [2*np.pi, 140, 40, 16]
